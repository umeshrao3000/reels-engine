...
// Pure presentation-only derivation — reads fields the pipeline (Milestones
// 3-6) already computed and stored; makes no decisions of its own. Not a
// duplication of pipeline business logic, just a human-readable label for
